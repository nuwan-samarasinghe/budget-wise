...
export const insertIncome = createAsyncThunk('income/insert', async (income: Income) => {
    await new Promise((res) => setTimeout(res, 500));
...
export const fetchMonthlyIncome = createAsyncThunk('income/fetchMonthly', async () => {
    await new Promise((res) => setTimeout(res, 500));
    //TODO waitting for backend
    return [
...
export const fetchYearlyIncome = createAsyncThunk('income/fetchYearly', async () => {
    await new Promise((res) => setTimeout(res, 500));
    //TODO waitting for backend
    return [
...
const salarySlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(insertIncome.fulfilled, (state, action: PayloadAction<Income>) => {
                state.loading = false;
