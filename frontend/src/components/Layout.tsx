...
export default function Layout() {
    ...
    return (
        <Box sx={{ display: 'flex', height: '100vh' }}>
            ...
            <Box component="nav" sx={{ width: { md: drawerWidth }, flexShrink: { md: 0 }, mt: { xs: 7, sm: 8 } }}>
                <Drawer
                ...
                >
                    <SidebarContent
                        onLinkClick={() => isMobile && toggleDrawer()}
                    />
                </Drawer>
            </Box>
            ...
            <Box
                component="main"
                sx={{ flexGrow: 1, p: 3, mt: 8, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}
                className="bg-brand-900 text-brand-50"
            >
